...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletMetaAssetsAssetItem: PalletMetaAssetsAssetItem;
    PalletMetaAssetsCall: PalletMetaAssetsCall;
    PalletMetaAssetsCollection: PalletMetaAssetsCollection;
    PalletMetaAssetsError: PalletMetaAssetsError;
    PalletMetaAssetsEvent: PalletMetaAssetsEvent;
