...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletMetaAssetsCall extends Enum {
    ...
    readonly type: 'AddAsset' | 'TransferAsset' | 'UpdateMeta';
  }
  ...
  /** @name PalletMetaAssetsError (117) */
  ...
  /** @name NodeTemplateRuntimeRuntime (133) */
